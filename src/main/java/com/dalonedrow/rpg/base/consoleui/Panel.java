...
public final class Panel {
	...
	public void join(final Panel other, final int direction, final int align)
		...
		case Panel.RIGHT:
			...
			if (maxWidth > UiSettings.SCREEN_WIDTH) {
		...
		case Panel.BOTTOM:
			...
			if (maxHeight > UiSettings.SCREEN_HEIGHT) {
				throw new RPGException(ErrorMessage.INTERNAL_BAD_ARGUMENT,
	 ...
	 * @param align the direction in which the panels are aligned, if they are
	 *            of different sizes
	 * @param isTopJoin if <tt>true</tt>, this panel is above the
	 * second panel; otherwise it is below
	 * @throws RPGException if an error occurs
	 */
	 ...
	 * @param align the direction in which the panels are aligned, if they are
	 *            of different sizes
	 * @param isTopJoin if <tt>true</tt>, this panel is above of the
	 * second panel; otherwise it is below
	 * @throws RPGException if an error occurs
	 */
