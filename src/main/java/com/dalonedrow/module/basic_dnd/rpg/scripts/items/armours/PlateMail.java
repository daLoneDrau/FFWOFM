...
/**
 * @author 588648
 * @see <a href="https://en.wikipedia.org/wiki/Plate_armour">Plate armour</a>
 */
public class PlateMail extends BDDScriptable {
	/*
	 * (non-Javadoc)
	...
	public int onInit() throws RPGException {
		...
		item.setItemName("Plate Armour");
		PooledStringBuilder sb = 
				StringBuilderPool.getInstance().getStringBuilder();
		try {
			sb.append("A full suit of personal body armour made from iron or ");
			sb.append("steel plates.");
		...
		item.getEquipitem().getElement(
		        BDDEquipmentGlobals.EQUIPITEM_ELEMENT_ARMOR_CLASS).setValue(-6);
