...
/**
 * @author 588648
 * @see <a href="https://en.wikipedia.org/wiki/Plated_mail">Plated mail</a>
 */
public class SplintMail extends BDDScriptable {
	/*
	 * (non-Javadoc)
	...
	public int onInit() throws RPGException {
		...
		item.setItemName("Plated Mail");
		PooledStringBuilder sb = 
				StringBuilderPool.getInstance().getStringBuilder();
		try {
			sb.append("A jacket of riveted mail embedded with plates of ");
			sb.append("armour.");
