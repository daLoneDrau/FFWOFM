...
/**
 * @author 588648
 * @see <a href="https://en.wikipedia.org/wiki/Gambeson">Gambeson</a>
 */
public class PaddedArmor extends BDDScriptable {
	/*
	 * (non-Javadoc)
	...
	public int onInit() throws RPGException {
		...
		item.setItemName("Gambeson");
		PooledStringBuilder sb = 
				StringBuilderPool.getInstance().getStringBuilder();
		try {
			sb.append("A long linen jacket stuffed with scraps of cloth ");
			sb.append("for added thickness.");
		...
		item.getEquipitem().getElement(
		        BDDEquipmentGlobals.EQUIPITEM_ELEMENT_ARMOR_CLASS).setValue(-1);
		io = null;
		item = null;
		return super.onInit();
	}
