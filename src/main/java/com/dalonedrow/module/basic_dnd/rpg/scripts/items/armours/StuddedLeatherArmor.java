...
/**
 * @author 588648
 * @see <a href="https://en.wikipedia.org/wiki/Brigandine">Brigandine</a>
 */
public class StuddedLeatherArmor extends BDDScriptable {
	/*
	 * (non-Javadoc)
	...
	public int onInit() throws RPGException {
		...
		item.setItemName("Brigandine");
		PooledStringBuilder sb =
		        StringBuilderPool.getInstance().getStringBuilder();
		try {
			sb.append("A canvas or leather jacket riveted with plates of ");
			sb.append("armour.");
