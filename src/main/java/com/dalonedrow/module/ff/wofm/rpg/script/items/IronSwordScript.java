...
public final class IronSwordScript extends WeaponScript {
	/**
	 * Creates a new instance of {@link IronSwordScript}.
	 * @param io the IO associated with the script
	 */
	public IronSwordScript(final FFInteractiveObject io) {
		super(io);
	}
	/**
	 * Enchants the item.
