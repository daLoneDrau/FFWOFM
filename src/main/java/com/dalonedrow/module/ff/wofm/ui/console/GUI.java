...
public class GUI {
    ...
    private String createTextWindow(final String windowHeader, 
        ...
        String text =
                TextProcessor.getInstance().processText(
                        ...
                        FFWebServiceClient.getInstance().getTextByName("table"));
        sb.returnToPool();
        sb = null;
        return text;
    }
    ...
    private String createErrorMessagesColumn(final int width) throws Exception {
        ...
        String text =
                TextProcessor.getInstance().processText(
                        ...
                        FFWebServiceClient.getInstance().getTextByName(
                        		"table_no_title"));
        sb.returnToPool();
        sb = null;
        return text;
    ...
    private String createStatsColumn() throws Exception {
        ...
        victoryTable =
                TextProcessor.getInstance().processText(
                        ...
                        WebServiceClient.getInstance().getTextByName("table"));
        sb.setLength(0);
        // time table
    ...
    public void setMenuMultipleColumns(final String title, final String header,
        ...
        menuTable = FFWebServiceClient.getInstance().getTextByName("menu_table");
